                ...
                <br>
                    <div class="column side">
                      <div class="card1">
                        ...
                        <br>
                        <button type="" class="update" name="" onclick="window.location.href='account_setting.php';">UPDATE PROFILE</button>  
                      </center>
                      <br>
                        <a href="personal_information.php" class="active">PERSONAL INFORMATION</a>
